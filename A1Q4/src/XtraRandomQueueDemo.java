 ...
 *
 */
public class XtraRandomQueueDemo {
	...
	public static void main(String[] args) {
		// STAGE 1. SETUP
		boolean testing = true; // Are we testing?

		// Display programmer info and create testing object
		TestSuite theTester = CommonSuite.commonProgramStart(1, 4, "RandomQueue", testing);

		// STAGE 2. DEMO REQUIRED TASKS
		...
		// STAGE 3. Let's recap. display testing results, if applicable
