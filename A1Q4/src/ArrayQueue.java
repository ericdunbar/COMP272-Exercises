 ...
 * 
 * THIS CLASS IS NEEDED TO SUPPORT RandomQueue.
 * 
 * See also:
...
public class ArrayQueue<T> extends AbstractQueue<T> {
	 ...
	 * 
	 * @throws IndexOutOfBoundsException if given index is < 0 or > size of
	 *             array queue
	 * @param idx index
	 * @return element
	 */
	...
	/**
	 * Resize the backing array when the number of elements exceeds the array's
	 * size or when the number of elements stored decreases below a certain
	 * point.
	 */
	...
	/**
	 * Attempts to add an element to the queue. Included for completeness. Not a
	 * strict implementation of offer since the method is not permitted to fail.
	 * A full queue situation is not allowed by this implementation of the
	 * AbstractQueue.
	 * 
	 * See:
